...
- A build 149 mantém a plataforma da build 148 e adiciona Deep Link `felpfit://`, notificações contextuais dez segundos antes do AlarmKit urgente e abertura direta da pergunta ou data correspondente.
